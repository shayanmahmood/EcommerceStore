...
function renderAddOn() {
    ...
    <h3>Add Items</h3>
                        <div class="container mb-3">
                            <img src="../assets/images/placeholer.png" style='width:500px; height:300px' class="imgAddNewItem img-thumbnail" alt="">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">
                        ...
                        <div class="container mb-3">
                        <p>Add hover photo</p>
                            <img src="../assets/images/placeholer.png" style='width:500px; height:300px' class="imgAddHoverNewItem img-thumbnail" alt="">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">
...
if (adminAppendChildBox) {
    ...
    editAddItem.addEventListener('click', () => {
        ...
        document.querySelector('.AddProductIDBTn').addEventListener('click', () => {
            ...
            document.querySelector('.imgAddNewItem').setAttribute('src', '../assets/images/placeholer.png')
